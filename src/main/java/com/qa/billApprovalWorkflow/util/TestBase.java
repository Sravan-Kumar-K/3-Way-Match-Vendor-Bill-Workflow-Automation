package com.qa.billApprovalWorkflow.util;
...
import com.qa.billApprovalWorkflow.ExtentReportsListeners.ExtentReportListener;
...
public class TestBase extends ExtentReportListener {
	...
	public TestBase() {
		try {
			prop = new Properties();
			FileInputStream fis = new FileInputStream("F:\\Selenium\\3WayMatchVendorBillApprovalWorkflow\\src\\main\\java\\com\\qa\\billApprovalWorkflow\\config\\config.properties");
			prop.load(fis);
		} catch(IOException e) {
			e.getMessage();
		}
