...
public class ExtentReportListener {
	...
	public static ExtentReports setUp() {
		...
		report = new ExtentSparkReporter(System.getProperty("user.dir") + "/Extent_report/3 Way Vendor Bill Automation Test Report.html");
		report.config().setDocumentTitle("3 Way Vendor Bill Workflow Automation"); // Tile of report
		report.config().setReportName("3 Way Vendor Bill Workflow Automation"); // Name of the report
